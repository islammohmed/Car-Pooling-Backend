...
namespace Car_Pooling.Migrations
{
    ...
    [Migration("20250602220702_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Car_Pooling.Models.Car", b =>
                {
            ...
            modelBuilder.Entity("Car_Pooling.Models.Trip", b =>
                {
            ...
            modelBuilder.Entity("Car_Pooling.Models.TripParticipant", b =>
                {
                    b.Property<int>("TripId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Car_Pooling.Models.User", b =>
                {
            ...
            modelBuilder.Entity("Car_Pooling.Models.Car", b =>
                {
                    b.HasOne("Car_Pooling.Models.User", "Driver")
                        .WithMany("Cars")
            ...
            modelBuilder.Entity("Car_Pooling.Models.TripParticipant", b =>
                {
                    b.HasOne("Car_Pooling.Models.Trip", "Trip")
                        .WithMany("Participants")
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Car_Pooling.Models.User", "User")
            ...
            modelBuilder.Entity("Chat", b =>
                {
                    b.HasOne("Car_Pooling.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("Receiver_ID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Car_Pooling.Models.User", "Sender")
                        .WithMany()
            ...
            modelBuilder.Entity("DeliveryRequest", b =>
                {
                    b.HasOne("Car_Pooling.Models.Trip", "AssignedTrip")
                        .WithMany()
            ...
            modelBuilder.Entity("DocumentVerification", b =>
                {
                    ...
                    b.HasOne("Car_Pooling.Models.User", "Admin")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Car_Pooling.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Payment", b =>
                {
                    b.HasOne("Car_Pooling.Models.User", "Payer")
                        .WithMany()
